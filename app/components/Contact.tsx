    ...
    const contactMethods = [
        {
            ...
            link: 'mailto:iutkarshgautam@gmail.com'
        },
        {
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            link: 'https://in.linkedin.com/in/utkarsh-gautam-578724310'
        },
        {
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            title: 'Instagram',
            value: '@__utkarsh_gautam',
            link: 'https://www.instagram.com/__utkarsh_gautam/'
        },
        {
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
